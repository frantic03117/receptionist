                            ...
                            <Grid container gap={1}>
                                {
                                    slots.map(itm => (
                                        <>
                                            <Grid onClick={() => handleSelectSlot(itm._id)} item className={`p-2 cursor-pointer text-xs border border-[var(--primary)] ${slot_id == itm._id ? 'bg-[var(--primary)] text-white' : ''}`} lg={2} xs={2}>
                                                {itm.name}
                                            </Grid>
                                        </>
                                    ))
